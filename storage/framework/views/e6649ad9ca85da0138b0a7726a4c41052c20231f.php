...
?>
        ...
        <div class="c-sidebar-brand">
            <img class="c-sidebar-brand-full" src="<?php echo e(url('/assets/brand/coreui-base-white.svg')); ?>" width="118" height="46" alt="CoreUI Logo">
            <img class="c-sidebar-brand-minimized" src="<?php echo e(url('assets/brand/coreui-signet-white.svg')); ?>" width="118" height="46" alt="CoreUI Logo">
        </div>
    ...
    </div><?php /**PATH D:\XAMPP\htdocs\inventory\resources\views/dashboard/shared/nav-builder.blade.php ENDPATH**/ ?>